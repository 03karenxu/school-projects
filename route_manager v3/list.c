 ...
 *
 */
node_t *new_node(char *sub, int stat)
{
    assert(sub != NULL);

    node_t *temp = (node_t *)emalloc(sizeof(node_t));

    temp->subject = strdup(sub);
    temp->statistic = stat;
    temp->next = NULL;
 ...
 * ----------------------
 * @brief  Allows to add a new node to the list respecting ascending order.
 *
 * @param list The list where the node will be added (i.e., a pointer to the first element in the list).
 * @param new The node to be added to the list.
 *
 ...
 * ----------------------
 * @brief  Allows to add a new node to the list respecting descending order.
 *
 * @param list The list where the node will be added (i.e., a pointer to the first element in the list).
 * @param new The node to be added to the list.
 *
