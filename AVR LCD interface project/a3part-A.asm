...
start:
	ldi r24, 0
	sts BUTTON_IS_PRESSED, r24 ; intialize BUTTON_IS_PRESSED to 0
	rjmp timer3
...
; within an interrupt handler).
	...
	; if button is pressed, jump to star
	lds r19, BUTTON_IS_PRESSED
	cpi r19, 1
	breq star

	; if button is not pressed, display '-'
	ldi r20, 1
	ldi r21, 15
	push r20 ;row
	push r21 ;column
	rcall lcd_gotoxy ; go to row 1 column 15
	pop r21
	pop r20

	ldi r20,'-'
	push r20
	rcall lcd_putchar ; print '-' at location specified above
	pop r20
	rjmp timer3
