function setAttribPointers(obj) {
    ...
    gl.vertexAttribPointer(obj.vTexCoord1, 2, gl.FLOAT, false, 0, 0);

    gl.bindBuffer(gl.ARRAY_BUFFER, obj.tBuffer);
    gl.vertexAttribPointer(obj.vTexCoord2, 2, gl.FLOAT, false, 0, 0);

    gl.bindBuffer(gl.ARRAY_BUFFER, obj.tBuffer);
    gl.vertexAttribPointer(obj.vTexCoord3, 2, gl.FLOAT, false, 0, 0);
...
function setBuffers(obj, program) {
    ...
    obj.vTexCoord1 = gl.getAttribLocation(program, "vTexCoord1");
    gl.vertexAttribPointer(obj.vTexCoord1, 2, gl.FLOAT, false, 0, 0);
    gl.enableVertexAttribArray(obj.vTexCoord1);

    obj.vTexCoord2 = gl.getAttribLocation(program, "vTexCoord2");
    gl.vertexAttribPointer(obj.vTexCoord2, 2, gl.FLOAT, false, 0, 0);
    gl.enableVertexAttribArray(obj.vTexCoord2);

    obj.vTexCoord3 = gl.getAttribLocation(program, "vTexCoord3");
    gl.vertexAttribPointer(obj.vTexCoord3, 2, gl.FLOAT, false, 0, 0);
    gl.enableVertexAttribArray(obj.vTexCoord3);
